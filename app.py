...
spam_clf = joblib.load(open(os.getcwd() + '/notebooks/models/spam_detector_model.pkl', 'rb'))
vectorizer = joblib.load(open(os.getcwd() + '/notebooks/models/vectorizer.pkl', 'rb'))
